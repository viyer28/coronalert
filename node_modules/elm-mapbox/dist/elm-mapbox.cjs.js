...
const _registerCustomElement = registerCustomElement;
export { _registerCustomElement as registerCustomElement };
const _registerPorts = registerPorts;
export { _registerPorts as registerPorts };
const _supported = supported;
export { _supported as supported };
